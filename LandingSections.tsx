...
export const LandingSections: React.FC<LandingSectionsProps> = ({ lang, currency = 'TRY' }) => {
  ...
  return (
    <div className="w-full flex flex-col gap-32 pb-20">
      ...
      <section className="relative max-w-6xl mx-auto px-6 w-full">
        <div className="text-center mb-16">
            <span className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-xs mb-2 block">Before & After</span>
        ...
        <div className="w-full max-w-5xl mx-auto aspect-[16/9] md:aspect-[21/9] rounded-3xl overflow-hidden shadow-2xl ring-1 ring-black/5 dark:ring-white/10 bg-gray-100 dark:bg-anthracite-800">
             <ComparisonSlider 
                beforeImage="https://images.unsplash.com/photo-1605100804763-247f67b3557e?q=80&w=2000&auto=format&fit=crop" 
                afterImage="https://images.unsplash.com/photo-1605100804763-247f67b3557e?q=80&w=2000&auto=format&fit=crop" 
      ...
      {/* Pricing Section */}
      <PricingSection lang={lang} onBuyClick={handleBuyClick} currency={currency} />
